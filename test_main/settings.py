...
SECRET_KEY = 'django-insecure-&$=h79zw)i9oupz*_n2xaym_amexvctv7iqnzilq%b5z0gou$d'
...
DATABASES = {
    'default': {
        ...
        'CLIENT': {
            ...
            'username': 'easycode',  # If authentication is needed
            'password': 'sm__nu@999#',  # If authentication is needed
            'authSource': 'admin',  # Default database for auth
...
MONGO_DB = {
    ...
    "AUTH_MECHANISM": "SCRAM-SHA-1",  # Authentication mechanism
}
